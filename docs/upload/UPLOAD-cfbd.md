...
`cfbd.yml` is the daily college-football data quota watcher. What changes in it:
...
https://github.com/smh0602/gizmos-picks/blob/main/docs/upload/cfbd.yml
...
**Upload files** → **choose your files**, pick `cfbd.yml`, and commit with:
