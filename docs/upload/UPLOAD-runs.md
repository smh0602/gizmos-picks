...
`runs.yml` is the hourly "did any workflow fail?" report. What changes in it:
...
https://github.com/smh0602/gizmos-picks/blob/main/docs/upload/runs.yml
...
**Upload files** → **choose your files**, pick `runs.yml`, and commit with:
