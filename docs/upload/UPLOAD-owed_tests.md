...
`owed_tests.yml` is the daily T58/T59 progress report. What changes in it:
...
https://github.com/smh0602/gizmos-picks/blob/main/docs/upload/owed_tests.yml
...
**Upload files** → **choose your files**, pick `owed_tests.yml`, and commit with:
