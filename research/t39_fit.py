#!/usr/bin/env python3
"""T39 — receiving yards. Fits and grades EXACTLY the pre-registered spec.
⛔ research/t39_spec.md was written and committed BEFORE this ran."""
...
X, y = design(fit)
beta = solve(X, y)
print("\ncoefficients (pre-registered spec, in order):")
